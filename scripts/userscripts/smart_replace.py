...
"""
#
# Almost entirely derived from replace.py by (C) Pywikibot team, 2004-2022, which is distributed under the terms of the MIT license.
#
# Subsequent code is relicensed as GNU 3.0
#
import codecs
import re
