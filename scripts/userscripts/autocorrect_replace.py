#!/usr/bin/python3
r"""
This bot uses the autocorrect module to do automatic spellchecks.
...
try:
    print(dir(autocorrect))
    from autocorrect import Speller
except ModuleNotFoundError:
    autocorrect_imported = False
else:
    autocorrect_imported = True
